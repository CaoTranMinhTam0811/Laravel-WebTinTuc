            ...
            flyTo: function (t, e, n) {
                ...
                function d() {
                    var i = (Date.now() - b) / T,
                        n = c(i) * w;
                    i <= 1
                        ? ((this._flyToFrame = o.Util.requestAnimFrame(
                              d,
                              this
                          )),
                          this._move(
        ...
        (o.GridLayer = o.Layer.extend({
                    ...
                    for (var r = 2 * e; r < 2 * e + 2; r++) {
                        ...
                        l && l.active
                            ...
                            : (l && l.loaded && (l.retain = !0),
                              i + 1 < n &&
                                  this._retainChildren(s, r, i + 1, n));
                    }
            },
            ...
            _update: function (t) {
                ...
                if (n) {
                    var s = n.getZoom();
                    if (
                        (t === i && (t = n.getCenter()), this._tileZoom !== i)
                    ) {
                        ...
                        for (var m = a.min.y; m <= a.max.y; m++)
                            for (var p = a.min.x; p <= a.max.x; p++) {
                                ...
                                if (
                                    ...
                                    var g =
                                        this._tiles[this._tileCoordsToKey(f)];
        ...
        (o.TileLayer.WMS = o.TileLayer.extend({
            ...
            initialize: function (t, e) {
                ...
                (e = o.setOptions(this, e)),
                    (i.width = i.height =
                        e.tileSize *
                        (e.detectRetina && o.Browser.retina ? 2 : 1)),
                    (this.wmsParams = i);
            },
            onAdd: function (t) {
        ...
        o.Map.include({
            getRenderer: function (t) {
                ...
                return (
                    e ||
                        (e = this._renderer =
                            (this.options.preferCanvas && o.canvas()) ||
                            o.svg()),
                ...
                if (n.distance === o.CRS.Earth.distance) {
                    ...
                    (isNaN(c) || 0 === c) &&
                        ...
                        (this._radius = isNaN(c)
                            ? 0
                            : Math.max(
                                  Math.round(l.x - i.project([u, t - c]).x),
                                  1
                              )),
                    ...
                    (this._point = i.latLngToLayerPoint(this._latlng)),
                        (this._radius =
                            this._point.x - i.latLngToLayerPoint(d).x);
                }
                this._updateBounds();
            },
        })),
            ...
            _addPointerStart: function (t, i, n) {
                var s = o.bind(function (t) {
                    if (
                        ...
                        if (
                            !(this.TAG_WHITE_LIST.indexOf(t.target.tagName) < 0)
                        )
                            return;
                        o.DomEvent.preventDefault(t);
                    }
        ...
        (o.Control.Scale = o.Control.extend({
            ...
            _addScales: function (t, e, i) {
                t.metric && (this._mScale = o.DomUtil.create("div", e, i)),
                    t.imperial &&
                        (this._iScale = o.DomUtil.create("div", e, i));
            },
            _update: function () {
                var t = this._map,
                    e = t.getSize().y / 2,
