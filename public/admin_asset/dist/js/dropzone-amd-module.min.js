                            ...
                            (this.prototype.Emitter = i),
                                ...
                                (this.prototype.defaultOptions = {
                                    ...
                                    resize: function (a, b, c, d) {
                                        ...
                                        return (
                                            (e.srcX =
                                                (a.width - e.srcWidth) / 2),
                                            (e.srcY =
                                                (a.height - e.srcHeight) / 2),
                                            (e.trgWidth = b),
                                            (e.trgHeight = c),
                                            e
                                        );
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function (a) {
                                if (a.dataTransfer) {
                                    ...
                                    if (
                                        (this.emit("addedfiles", b), b.length)
                                    ) {
                            ...
                            value: function (a) {
                                ...
                                return (function () {
                                    for (
                                        ...
                                        var h,
                                            i = g;
                                        null != i.webkitGetAsEntry &&
                                        (h = i.webkitGetAsEntry())
                                            ? h.isFile
                                                ? c.push(
                                                      b.addFile(i.getAsFile())
                                                  )
                                                : h.isDirectory
                                                ? c.push(
                                ...
                                this._transformFiles(a, function (c) {
                                    if (a[0].upload.chunked) {
                                        ...
                                        var h = function () {
                                            for (
                                                var c = 0;
                                                void 0 !== d.upload.chunks[c];

                                            )
                                                c++;
                                            if (
                                                !(c >= d.upload.totalChunkCount)
                                            ) {
                                                f++;
                                                var h = c * b.options.chunkSize,
                                                    i = Math.min(
                                                        h + b.options.chunkSize,
                                                        d.size
                                                    ),
                                                    j = {
                                                        name: b._getParamName(
                                                            0
                                                        ),
                                                        data: e.webkitSlice
                                                            ? e.webkitSlice(
                        ...
                        },
                        {
                            ...
                            value: function (a, b) {
                                ...
                                a[0].upload.chunked &&
                                    (a[0].upload.chunks[b[0].chunkIndex].xhr =
                                        d);
                                var j = this.resolveOption(
                                        this.options.method,
                                        a
                                    ),
                                    k = this.resolveOption(this.options.url, a);
                                d.open(j, k, !0),
                                    (d.timeout = this.resolveOption(
                                    ...
                                    ((null != d.upload
                                        ...
                                        return c._updateFilesUploadProgress(
                                            a,
                                            d,
                                            b
                                        );
                                ...
                                this.options.headers &&
                                    g.extend(l, this.options.headers);
                                for (var m in l) {
                                    var n = l[m];
